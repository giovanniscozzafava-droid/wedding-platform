  ...
  },
  {
    ...
    questions: [
      { key: 'coverage_hours', label: 'Quante ore di copertura ti servono', type: 'select',
        ...
        help: 'Per capirci: “fino a 4 ore” = solo cerimonia; “6-8 ore” = dai preparativi al taglio torta; “full day” = fino al ballo della sera.' },
      { key: 'second_shooter', label: 'Serve un secondo fotografo?', type: 'select',
        options: ['sì_lo_voglio', 'forse_consigliami_tu', 'no_ne_basta_uno'],
        help: 'Due fotografi = due punti di vista nello stesso istante: es. mentre uno riprende la sposa che entra, l’altro riprende la faccia dello sposo. Utile con tanti invitati o se volete i preparativi di entrambi in contemporanea.' },
...
const Q_LOCATION: QuestionnaireSection[] = [
  {
    ...
    questions: [
      ...
      { key: 'guests_count', label: 'Numero invitati stimato', type: 'number', required: true,
        help: 'Anche a spanne va bene: es. 80 vuol dire una sala media, 200 una grande. Meglio contarli larghi.' },
      { key: 'kids_count', label: 'Quanti bambini pensi ci saranno?', type: 'number',
        help: 'Serve per prevedere seggioloni, menù bimbi e magari uno spazio giochi. Es. 0, oppure “una decina tra i 3 e i 10 anni”.' },
      { key: 'ceremony_in_venue', label: 'Cerimonia in struttura?', type: 'select', options: ['sì_civile', 'sì_simbolica', 'no_solo_ricevimento'],
        help: '“Civile” = con valore legale (serve che la location sia autorizzata); “simbolica” = una cerimonia scenografica senza valore legale; “no” = vi sposate altrove e qui fate solo la festa.' },
      { key: 'reception_kind', label: 'Tipo ricevimento', type: 'select',
        options: ['pranzo_seduto', 'cena_seduta', 'aperitivo_lungo', 'cocktail_party'],
        help: '“Seduto” = tutti a tavola con portate servite; “aperitivo lungo” = in piedi, si gira tra le isole di cibo; “cocktail party” = più informale, drink e finger food.' },
    ],
  },
  {
    title: 'Logistica',
