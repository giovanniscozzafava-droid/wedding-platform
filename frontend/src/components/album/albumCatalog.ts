...
export const MATERIALS: Material[] = [
  { key: 'wood', label: 'Legno (Wood)', texture: 'acero', swatch: '#8a5c38', albedo: true,
    ...
    colors: [
      Cw('Noce', '#8a5c38', '/textures/wood/noce.jpg?v=2'),
      Cw('Rovere', '#c79a63', '/textures/wood/rovere.jpg?v=2'),
      Cw('Ciliegio', '#a0512f', '/textures/wood/ciliegio.jpg?v=2'),
      Cw('Okumè', '#c98a5e', '/textures/wood/okume.jpg?v=2'),
      Cw('Moka', '#4a3526', '/textures/wood/moka.jpg?v=2'),
      Cw('Ulivo', '#8a7a4a', '/textures/wood/ulivo.jpg?v=2'),
    ] },
