...
import {
  LayoutDashboard, PackageSearch, CalendarDays, FileText, UserRound, Gem, Sun, Moon,
  LogOut, Menu, X, Wallet, BarChart3, FileSignature, HelpCircle, LifeBuoy, Handshake,
  Newspaper, Inbox, LayoutGrid, Settings, ClipboardCheck,
