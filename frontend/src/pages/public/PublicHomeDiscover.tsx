...
import { Search, MapPin, Heart, Camera, Building2, Briefcase, ArrowRight, Eye } from '@/components/icons/lucide'
      ...
      <header className="absolute top-0 left-0 right-0 z-20">
        <div className="max-w-6xl mx-auto px-6 sm:px-10 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <Link to="/richiedi-accesso" className="px-3 py-1.5 rounded-full text-xs font-medium"
