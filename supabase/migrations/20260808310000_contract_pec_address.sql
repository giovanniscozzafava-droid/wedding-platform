-- ============================================================================
-- Legal #4/#12: nel contratto (build_contract_sections)
--  #4: la PEC del Prestatore era un placeholder fisso mai sostituito -> ogni
--      contratto mostrava "[email PEC del Prestatore da inserire]". Ora legge
--      v_owner.pec_email (fallback al placeholder).
--  #12: l'indirizzo Prestatore nelle Premesse usava solo citta+paese, ignorando
--      profiles.address (usato invece nel corpo del PDF). Ora include address.
-- Estratto byte-per-byte da 20260808090000; sole modifiche: righe 75-76.
-- ============================================================================
