-- La notifica al referrer ("un fornitore che hai suggerito ha inviato un preventivo") ora
-- porta al landing "Suggerimenti inviati" (/suggerimenti-inviati), dove si vede l'esito,
-- invece del vecchio /rete. Riscrive solo la funzione; il trigger su quotes resta.
