-- ============================================================================
-- N8 (blind leak): sulle voci CIECHE veniva comunque restituita la foto del
-- servizio (thumbnail via service_id). Una foto brandizzata/watermarkata puo
-- identificare il fornitore aggirando il masking del nome. Nascondiamo la foto
-- quando la voce e cieca, in client_portal_overview e couple_get_quote_for_entry.
-- Funzioni estratte byte-per-byte da 20260807050000, sola modifica: campo photo.
-- ============================================================================
