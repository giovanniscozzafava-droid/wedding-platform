-- Problema: il fornitore si registra dal link, il token diventa ACCETTATO, e se torna sul link
-- vede "invito non valido" senza sapere come accedere. Ora distinguiamo "già accettato"
-- (→ offriamo l'ACCESSO) da "invalido/scaduto".
