-- Contratto con VALORE: premesse arricchite con dati fiscali delle PARTI
-- (P.IVA/C.F. del Prestatore e del Committente) e LOCATION dell'Evento, cosi'
-- il documento e' completo/valido. Dati cliente dalla rubrica fornitore
-- (supplier_clients via direct_client_id); C.F. mancante -> '[da completare]'.
...
declare
  ...
  v_sc record; v_prov_fiscal text; v_cli_fiscal text; v_location text;
begin
