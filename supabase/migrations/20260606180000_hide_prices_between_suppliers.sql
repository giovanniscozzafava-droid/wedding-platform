-- ============================================================================
-- I fornitori NON vedono i prezzi degli altri fornitori. Nel profilo pubblico
-- il base_price viene azzerato (→ "Prezzo su richiesta" lato UI) quando il
-- visitatore è un FORNITORE diverso dal proprietario del profilo. Capostipiti
-- (WP/LOCATION), clienti e visitatori pubblici continuano a vedere i prezzi.
-- ============================================================================
...
begin
  select * into v_profile from profiles
   where slug = p_slug
     and role in ('FORNITORE','LOCATION')
