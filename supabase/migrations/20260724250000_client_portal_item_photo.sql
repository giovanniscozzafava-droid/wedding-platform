-- Area cliente (/area-cliente): aggiunge la FOTO a ogni voce del preventivo (prima service_photo
-- del servizio d'origine), così le voci si vedono con l'immagine come nel tab Preventivo della coppia.
-- Il raggruppamento per categoria era già stato aggiunto in 20260723180000. Resto IDENTICO.
