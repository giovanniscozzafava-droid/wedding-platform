-- ============================================================================
-- Fix RPC get_supplier_public_profile: alias sp.url inesistente
-- ----------------------------------------------------------------------------
-- Bug: la pagina pubblica /p/fornitore/<slug> errorava con
--   "column sp.url does not exist"
-- perche service_photos ha original_url e thumbnail_url, mai una colonna "url".
-- Stessa cosa per sp.caption che non esiste.
-- ============================================================================
