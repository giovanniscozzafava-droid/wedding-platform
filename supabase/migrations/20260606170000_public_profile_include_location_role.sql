-- ============================================================================
-- La pagina pubblica "fornitore" ora serve anche le LOCATION: un wedding planner
-- deve poter aprire il profilo di una Location e aggiungerla al proprio team
-- (Location come capostipite -1). Aggiungiamo anche 'role' nell'output così il
-- frontend sa se il target è subordinabile.
-- ============================================================================
