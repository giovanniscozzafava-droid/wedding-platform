-- ============================================================================
-- #2: il contratto (build_contract_sections) usa il PIANO PAGAMENTI del pro
-- (profiles.pay_deposit_pct/pay_second_pct/pay_balance_pct, default 30/50/20)
-- invece del 30/40/30 fisso. La rata finale e calcolata a RESIDUO (chiude anche
-- il #11: le tre rate sommano sempre al totale). Testo legale invariato salvo
-- l Art. 2.2. Estratto byte-per-byte da 20260808310000.
-- ============================================================================
