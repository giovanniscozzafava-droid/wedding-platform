-- Auto-genera DiceBear logo per fornitori che accettano un invito senza logo.
-- Il DiceBear avatar viene usato come fallback finche' il fornitore non
-- carica un suo logo vero da BrandSettingsPage.
