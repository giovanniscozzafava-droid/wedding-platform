// Avvia il collegamento Google Calendar del professionista (sola lettura: calendar.readonly).
// Riusa la stessa app Google del Drive (GOOGLE_DRIVE_CLIENT_ID/SECRET). Serve solo per
// LEGGERE gli impegni e bloccare gli slot di prenotazione. Nessuna scrittura sul calendario.
...
Deno.serve(async (req) => {
  ...
  if (!CLIENT_ID) return json({ error: 'no_google_app' }, 503)
