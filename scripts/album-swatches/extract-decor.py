...
SPEC = {
  ...
  'dhyana':  dict(page=47, quad=[(5813, 1059), (8020, 1248), (8014, 1923), (5861, 2166)], size=(1200, 850), color=True, dematte=False, white=232, k_w=30, thr_c=10, k_c=8, blur=41, med=5, min_area=60, names=dict(x=0.80, y=0.55), keep=(0.02, 0.02, 0.96, 0.92), erase=[(0.6, 0.47, 0.98, 0.62), (0.82, 0.0, 1.0, 0.22), (0.5, 0.88, 1.0, 1.0), (0.9, 0.3, 1.0, 0.45)]),
