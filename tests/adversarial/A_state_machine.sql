...
-- ✅ RISOLTI (Cluster 2, mig. 20260611020000) → VERDI in
--    tests/sql/cluster2_snapshot_prezzi.sql: A-12, A-14, A-15, E-SNAPSHOT-02/03.
--    → Tutta la famiglia A è ora chiusa; rilanciando questo file nessun BRK-A fa rosso.
-- ----------------------------------------------------------------------------
